 ...
 * Input parameters: binStr (const string ref): binary value
 * Returns: dec (int): decimal value
**/
 ...
 * Input parameters: hexStr (const string ref): hexadecimal value
 * Returns: dec (long): decimal value
**/
 ...
 * Input parameters: dec (unsigned int): decimal value
 * Returns: binStr (string): binary value
**/
 ...
 * Assumption: parameter dec < UINT_MAX (unsigned int max)
 * Input parameters: dec (unsigned int): decimal value
 * Returns: hexStr (string): hexadecimal value
**/
